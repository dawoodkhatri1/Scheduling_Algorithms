...
st.markdown("""
    ...
    <div class="animated-title-pulse">
        <h3 style='color: #FF5733;'>Dawood M.Shoaib</h3>
    </div>
""", unsafe_allow_html=True)
...
st.markdown("""
    ...
    <div class="animated-title-pulse">
        <h3 style='color: #FF5733;'>M.Saif Khan</h3>
    </div>
""", unsafe_allow_html=True)
...
st.markdown("""
    ...
    <div class="animated-title-pulse">
        <h3 style='color: #FF5733;'>Bilal Ahmed</h3>
    </div>
""", unsafe_allow_html=True)
...
st.markdown("""
    ...
    <div class="animated-title-pulse">
        <h3 style='color: #FF5733;'>Aaima Sohail</h3>
    </div>
""", unsafe_allow_html=True)
